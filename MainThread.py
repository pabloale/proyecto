...
while True:
    ...
    if (dataSensores.noHayNadieSentado()):
        activarActuadores(LED_VERDE_IZQ, LED_VERDE_DER, LED_ROJO_IZQ, LED_ROJO_DER, VIBRADOR, dataSensores.getConfigActuadorVibrador(), dataSensores.getConfigActuadorLed(), GPIO.LOW, GPIO.LOW)
    elif (dataSensores.bienSentado()):
        activarActuadores(LED_VERDE_IZQ, LED_VERDE_DER, LED_ROJO_IZQ, LED_ROJO_DER, VIBRADOR, dataSensores.getConfigActuadorVibrador(), dataSensores.getConfigActuadorLed(), GPIO.HIGH, GPIO.LOW)
    else: #algun sensor no esta activado, no está bien sentado
        activarActuadores(LED_VERDE_IZQ, LED_VERDE_DER, LED_ROJO_IZQ, LED_ROJO_DER, VIBRADOR, dataSensores.getConfigActuadorVibrador(), dataSensores.getConfigActuadorLed(), GPIO.LOW, GPIO.HIGH)
